...
public class AirLocation extends org.optaplanner.examples.vehiclerouting.domain.location.Location {
    ...
    @Override
    public long getDistanceTo(org.optaplanner.examples.vehiclerouting.domain.location.Location location) {
