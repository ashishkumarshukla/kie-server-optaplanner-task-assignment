...
public class Customer extends AbstractPersistable implements Standstill {
    ...
    protected org.optaplanner.examples.vehiclerouting.domain.Vehicle vehicle;
    ...
    public org.optaplanner.examples.vehiclerouting.domain.Vehicle getVehicle() {
        return vehicle;
    }

    public void setVehicle(org.optaplanner.examples.vehiclerouting.domain.Vehicle vehicle) {
