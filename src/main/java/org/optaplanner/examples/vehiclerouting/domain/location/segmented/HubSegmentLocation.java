...
public class HubSegmentLocation extends Location {
    ...
    protected Map<org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation, Double> nearbyTravelDistanceMap;
    ...
    public Map<org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation, Double> getNearbyTravelDistanceMap() {
        return nearbyTravelDistanceMap;
    }

    public void setNearbyTravelDistanceMap(Map<org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation, Double> nearbyTravelDistanceMap) {
    ...
    public long getDistanceTo(Location location) {
        double distance;
        if (location instanceof org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation) {
            distance = getDistanceDouble((org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation) location);
        } else {
    ...
    public double getDistanceDouble(org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation location) {
    ...
    protected double getShortestDistanceDoubleThroughOtherHub(org.optaplanner.examples.vehiclerouting.domain.location.segmented.RoadSegmentLocation location) {
